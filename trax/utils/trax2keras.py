...
from trax.utils import shapes as shapes_lib
...
class AsKeras(tf.keras.layers.Layer):
    ...
    Consider this code snippet::
        ...
        keras_layer = AsKeras(
            trax_layer, initializer_rng=initializer_rng, rng=rng, rng_updater=rng_updater
        )
    ...
    equivalent to::
        ...
        outputs, new_state = trax_layer(
            inputs, keras_layer._weights, keras_layer._state, keras_layer._rng
        )
