...
flags.DEFINE_int('gpu_cluster_n_hosts', 1, 'Number of hosts in GPU cluster.')
flags.DEFINE_int('gpu_cluster_host_id', 0, 'Host id inside GPU cluster.')
flags.DEFINE_int('gpu_cluster_n_hosts', 1, 'Number of hosts in GPU cluster.')
flags.DEFINE_int('gpu_cluster_port', 5005, 'Port to use in GPU cluster.')
