...
class ConfigurableTransformerTest(parameterized.TestCase):
    ...
    def _test_transformer_forward_shape(self, input_vocab_size, output_vocab_size):
    ...
    @parameterized.named_parameters(
        ("same_vocab", 16, None), ("same_size", 16, 16), ("different_size", 16, 50)
    )
    ...
    def test_embedding_and_positional_encodings(
        self, input_vocab_size, output_vocab_size
    ):
        d_model = 16
        max_len = 32
        batch = 2
