...
class TaskTest(absltest.TestCase):
    ...
    def test_task_save_init(self):
        ...
        task1 = rl_task.RLTask(
            DummyEnv(), initial_trajectories=13, max_steps=9, gamma=0.9
        )
        ...
        task2 = rl_task.RLTask(
            DummyEnv(), initial_trajectories=3, max_steps=19, gamma=1.0
        )
    ...
    def test_trajectory_slice_stream_sampling_uniform(self):
        ...
        task = rl_task.RLTask(DummyEnv(), initial_trajectories=[tr1, tr2], max_steps=9)
