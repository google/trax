...
def DecoderBlock(
    ...
    def _feed_forward():
        return [
            tl.ReversibleHalfResidual(_FF(), name="ReversibleHalfResidualDecoderFF"),
            tl.ReversibleSwap(),
        ]
...
def EncoderBlock(
    ...
    def _feed_forward():
        layers = [
            tl.ReversibleHalfResidual(_FF(), name="ReversibleHalfResidualEncoderFF")
        ]
