...
def TransformerEncoder(
    ...
    def _EncBlock():
        return _EncoderBlock(
            d_model, d_ff, n_heads, dropout, dropout_shared_axes, mode, ff_activation
        )
...
def _FeedForwardBlock(d_model, d_ff, dropout, dropout_shared_axes, mode, activation):
