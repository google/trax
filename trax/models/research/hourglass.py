...
from trax.layers.research.resampling import AttentionResampling, \
  AveragePooling, LinearUpsampling, FeedForwardBlock
...
def _RelativeDecoderBlock(attention_type, d_model,
  ...
  """Returns a list of layers that implements a Transformer decoder block with
    relative attention parametrization.
...
def _parse_hierarchy(hierarchy_str):
