...
class HourglassTest(parameterized.TestCase):
    ...
    def _test_autoregressive_property(self, model, input_shape, output_vocab_size):
    ...
    def test_hourglass_lm_autoregressive_property(self):
        ...
        self._test_autoregressive_property(
            model_single_stage, input_shape, output_vocab_size=vocab_size
        )
        self._test_autoregressive_property(
            model_multi_stage, input_shape, output_vocab_size=vocab_size
        )

    def test_parse_hourglass_hierarchy(self):
        self.assertEqual(hourglass._parse_hierarchy("6@3"), ([6], [3]))
        self.assertEqual(
            hourglass._parse_hierarchy("3@2 2@6 5@24 2@6 3@2"), ([3, 2, 5], [2, 3, 4])
        )
