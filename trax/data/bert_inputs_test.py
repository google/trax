...
class BertInputsTest(absltest.TestCase):
  ...
  def test_bert_tokenizer(self):
    ...
    tokenizer = bert_inputs.BertLegacyTokenizer(model_name='bert-base-uncased')
  ...
  def test_glue_inputs(self):
    ...
    tokenizer_fn = partial(bert_inputs.BertLegacyTokenizer, model_name='bert-base-uncased')
    ...
    self.assertEqual(12085, sample_batch[0][2, 1])
